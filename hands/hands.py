...
# Вот тут параметры со значениями 0.9 и 0.9 эти значения скорее всего надо будет в настройки запихнуть
# т.к они отвечают за чувствительность нейронки к опознаванию рук и тп
# у всех вебки разные у кого то нормальные у кого то нет и по этому эту прогу надо в игру вшить для теста вебки и её калибровки
